...
class _SliderScreenState extends State<SliderScreen> {
  ...
  List<Item> imgList = <Item>[
    const Item('assets/images/s1.jpg', 'SEARCH JOBS',
        'If youre looking for a part-time or hourly job, then findjob is your app.'),
    const Item('assets/images/s2.jpg', 'APPLY JOB',
        'If youre looking for a part-time or hourly job, then findjob is your app.'),
    const Item('assets/images/s3.jpg', 'READY TO WORK!',
        'If youre looking for a part-time or hourly job, then time or hourly job findjob is your app.'),
  ];
